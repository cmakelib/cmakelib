...
#	GIT supported
#
# CMLIB_REQUIRED_ENV_7ZIP - path to 7zip executable
# CMLIB_REQUIRED_ENV_GIT_EXECUTABLE - path to Git executable
#
...
FUNCTION(CMLIB_REQUIRED_ENV)
	...
	_CMLIB_REQUIRED_ENV_FIND_7ZIP()
	_CMLIB_REQUIRED_ENV_FIND_TAR()
...
# )
#
MACRO(_CMLIB_REQUIRED_ENV_FIND_7ZIP)
	FIND_PROGRAM(CMLIB_REQUIRED_ENV_7ZIP
		NAMES 7z 7za
		DOC "7zip executable"
	)
...
# )
#
MACRO(_CMLIB_REQUIRED_ENV_FIND_TAR)
	CMAKE_HOST_SYSTEM_INFORMATION(RESULT system_name QUERY OS_NAME)
	IF(NOT system_name STREQUAL "Windows")
		FIND_PROGRAM(CMLIB_REQUIRED_ENV_TAR
			NAMES tar
			DOC "tar executable"
		)
		IF("${CMLIB_REQUIRED_ENV_TAR}" STREQUAL "CMLIB_REQUIRED_ENV_TAR-NOTFOUND")
			SET(CMLIB_REQUIRED_ENV_TAR "NOTFOUND"
				CACHE STRING
				""
				FORCE
			)
