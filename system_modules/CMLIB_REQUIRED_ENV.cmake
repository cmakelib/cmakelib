...
MACRO(_CMLIB_REQUIRED_ENV_FIND_GIT)
	SET(CMLIB_REQUIRED_ENV_GIT_MIN_VERSION "2.11.0"
		CACHE STRING
...
MACRO(_CMLIB_REQUIRED_ENV_TMP_PATH)
	...
	IF(NOT "$ENV{CMLIB_REQUIRED_ENV_TMP_PATH}" STREQUAL "")
		SET(_bimcm_cache_path "$ENV{CMLIB_REQUIRED_ENV_TMP_PATH}")
	ENDIF()
	FILE(TO_CMAKE_PATH "${_bimcm_cache_path}" _bimcm_cache_path_tr)
	SET(CMLIB_REQUIRED_ENV_TMP_PATH "${_bimcm_cache_path_tr}"
		CACHE PATH
